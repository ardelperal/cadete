<head>
    ...
    <!-- Título -->
        <title> Mejora | <?php echo $_SESSION["nombreApp"]; ?> </title>
...
<main class="template1">
    ...
    <!-- Breadcrumb -->
        ...
        <nav class="breadcrumb">
            ...
            <ol class="breadcrumb__list">
                ...
                <li class="breadcrumb__item actual"> <a href="/desempeno"> Mejora </a> </li>
    ...
    <!-- Título -->
        ...
        <header class="entry-header">
            <h1 class="entry-title"> Mejora </h1>
        </header>
            ...
            <div class="mega">
                ...
                <div class="mega__content">
                    ...
                    <div class="mega__left">
                        ...
                        <svg class="ico ico__progreso w"> </svg>

                        <h2>
                            Conoce los mecanismos del sistema de gestión de calidad para mejorar sus procesos y desempeño.
                        </h2>
                    ...
                    <div class="mega__right">
                        ...
                        <div class="mega__media">
                            <img src="/build/img/content/fondo_login.jpg">
                        </div>
            ...
            <div class="wp-block-column">
                ...
                <div class="block">
                    ...
                    <div class="block__text">
                        ...
                        <h3 class="block__title"> No Conformidad y acción correctiva </h3>

                        <div class="block__desc">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur, nobis!
                        </div>

                        <a class="block__link" href="/obras"> 
            ...
            <div class="wp-block-column">
                ...
                <div class="block">
                    ...
                    <div class="block__text">
                        ...
                        <h3 class="block__title"> Mejora continua </h3>
